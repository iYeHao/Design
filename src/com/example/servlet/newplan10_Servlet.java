...
public class newplan10_Servlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/newplan9.jsp").forward(request, response);
	}
