...
public class newplan_Servlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		flist.add(f);
		String ftext1=new String(request.getParameter("yj").getBytes("8859_1"),"utf-8");
		String fname1="编制依据";
		...
		request.getRequestDispatcher("/newplan.jsp").forward(request, response);
	}
