...
<div class="container">
 ...
 <form action="revise_password_Servlet" method="post">
        ...
        <td><table width="100%" border="1">
          <tr>
            <td width="413">
              ...
              <p>原密码：
                <label for="yps"></label>
                <input type="text" name="fpassword" id="yps" value="${user.upassword }"/>
              </p>
              <p>新密码：
                <label for="xps"></label>
                <input type="text" name="newpassword" id="xps" />
              </p>
              <p>确认密码：
                <label for="zps"></label>
                <input type="text" name="cpassword" id="zps" />
              </p>
              <p>&nbsp;</p>
              <p align="center">
                <input name="change" type="submit" class="header" id="change" value="修改" />
              </p>
            </td>
          </tr>
        </table></td>
