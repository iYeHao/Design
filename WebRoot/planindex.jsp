...
<div class="container">
  ...
  <div class="content" align="center"><!-- InstanceBeginEditable name="EditRegion3" -->
    <form id="form1" name="form1" method="post" action="planindex_Servlet">
      <p>&nbsp;</p>
      <p align="center">
        <label for="pname">预案名称：</label>
        <input type="text" name="pname" id="pname" value="${p.pname }" />
      </p>
      <p align="center">灾害类型：
        <label for="type"></label>
        <input type="text" name="ptype" id="type" value="${p.ptype }" />
      </p>
      <p align="center">
