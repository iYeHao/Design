...
<div class="container">
  ...
  <div class="content" align="center"><!-- InstanceBeginEditable name="EditRegion3" -->
    <form id="form1" name="form1" method="post" action="newplan3_Servlet">
      <p>1.特大灾害事件应急管理：
</p>
      <p>
        <label for="tdgl"></label>
        <textarea name="tdgl" id="tdgl" cols="65" rows="5"></textarea>
      </p>
      <p>2.重大灾害事件应急管理：</p>
      <p>
        <label for="zdgl"></label>
        <textarea name="zdgl" id="zdgl" cols="65" rows="5"></textarea>
      </p>
      <p>3.较大灾害事件应急管理：</p>
      <p>
        <label for="jdgl"></label>
        <textarea name="jdgl" id="jdgl" cols="65" rows="5"></textarea>
      </p>
      <p>4.一般灾害事件应急管理：</p>
      <p>
        <label for="ybgl"></label>
        <textarea name="ybgl" id="ybgl" cols="65" rows="5"></textarea>
      </p>
      <p align="center">
