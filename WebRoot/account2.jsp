...
<div class="container">
  <div class="header"><a href="#"><img src="images/logo.jpg" alt="在此处插入徽标" name="Insert_logo" width="500" height="90" id="Insert_logo" style="background-color: #8090AB; display:block;" /></a> 
    ...
    <a href="index.jsp"><input style="margin-left:20%" name="submit2" type="submit" class="logout_user" value="返回主页"/></a>
</div>
  <div class="sidebar1">
  <h3>用户资料</h3>
    <ul class="nav">
  ...
  <form action="revise_user_Servlet" method="post">
          ...
          <tr>
            <td><p>&nbsp;</p>
              ...
              <p>
                ...
                <input name="uage" type="text" id="age" value="${user.uage }" />
  &nbsp;</p>
              <p>真实姓名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label for="email"></label>
                <input name="urealname" type="text" id="email" value="${user.urealname }" />
              </p>
              <p> 职&nbsp;&nbsp;&nbsp;位：              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label for="zw"></label>
                <input name="uposition" type="text" id="zw" value="${user.uposition }"/>
            </p>
            <p> 邮&nbsp;&nbsp;&nbsp;箱：              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label for="zw"></label>
                <input name="uemail" type="text" id="zw" value="${user.uemail }"/>
            </p>
              <p>&nbsp; </p>
              <p align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 <input name="register" type="submit" class="header" id="register" value="修改" />
  &nbsp;&nbsp;</p>
              <p></p></td>
          </tr>
        </table></td>
