...
<div class="container">
  ...
  <div class="content" align="center"><!-- InstanceBeginEditable name="EditRegion3" -->
    <form id="form1" name="form1" method="post" action="newplan10_Servlet">
      <p>1. 灾害名称：
        <label for="zhmc"></label>
        <input type="text" name="zhmc" id="zhmc" />
      </p>
      <p>2. 灾害等级：
        <label for="zhdj"></label>
        <input type="text" name="zhdj" id="zhdj" />
      </p>
      <p>3. 应急启动：</p>
      <p>
        <label for="tdqd"></label>
        <textarea name="tdqd" id="tdqd" cols="65" rows="5"></textarea>
      </p>
      <p>4.指挥与部署</p>
      <p>
