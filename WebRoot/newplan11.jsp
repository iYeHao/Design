...
<div class="container">
  ...
  <div class="content" align="center"><!-- InstanceBeginEditable name="EditRegion3" -->
    <form id="form1" name="form1" method="post" action="newplan11_Servlet">
      <p>1.
    组织指挥体系建设：</p>
  <p>
    <label for="tdqd"></label>
    <textarea name="tdqd" id="tdqd2" cols="65" rows="5"></textarea>
  </p>
  <p>2.应急救援体系建设规划：</p>
  <p>
    <label for="tdbs"></label>
    <textarea name="tdbs" id="tdbs" cols="65" rows="5"></textarea>
  </p>
  <p>3.灾害应急预案体系建设：</p>
  <p>
    <label for="tdjs"></label>
    <textarea name="tdjs" id="tdjs" cols="65" rows="5"></textarea>
  </p>
  <p>4.
    应急指挥技术体系建设：</p>
  <p>
    <label for="tdqd2"></label>
    <textarea name="tdqd2" id="tdqd2" cols="65" rows="5"></textarea>
  </p>
  <p>5.抢险救援队伍体系建设：</p>
  <p>
    <label for="tdbs2"></label>
    <textarea name="tdbs2" id="tdbs2" cols="65" rows="5"></textarea>
  </p>
  <p>6.救灾物资储备调度体系建设：</p>
  <p>
    <label for="tdjs2"></label>
    <textarea name="tdjs2" id="tdjs2" cols="65" rows="5"></textarea>
  </p>
  <p>7.灾害应急科普宣传：</p>
  <p>
    <label for="zhkp"></label>
    <textarea name="zhkp" id="zhkp" cols="65" rows="5"></textarea>
  </p>
  <p>8.志愿者队伍建设：</p>
  <p>
    <label for="zyz"></label>
    <textarea name="zyz" id="zyz" cols="65" rows="5"></textarea>
  </p>
  <p align="center">
