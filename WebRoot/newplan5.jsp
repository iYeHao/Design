...
<div class="container">
  ...
  <div class="content" align="center"><!-- InstanceBeginEditable name="EditRegion3" -->
    <form id="form1" name="form1" method="post" action="newplan5_Servlet">
      <p>1.分级响应机制
</p>
      <p>
        <label for="fjxy"></label>
        <textarea name="fjxy" id="fjxy" cols="65" rows="5"></textarea>
      </p>
      <p>2.自行启动机制</p>
      <p>
        <label for="zxxy"></label>
        <textarea name="zxxy" id="zxxy" cols="65" rows="5"></textarea>
      </p>
      <p>3.分工协作机制</p>
      <p>
        <label for="fgxy"></label>
        <textarea name="fgxy" id="fgxy" cols="65" rows="5"></textarea>
      </p>
      <p>4.信息共享机制</p>
      <p>
        <label for="xxxy"></label>
        <textarea name="xxxy" id="xxxy" cols="65" rows="5"></textarea>
      </p>
      <p>5.社会动员机制</p>
      <p>
        <label for="shxy"></label>
        <textarea name="shxy" id="shxy" cols="65" rows="5"></textarea>
      </p>
      <p align="center">
