...
<div class="container">
  ...
  <div class="content" align="center"><!-- InstanceBeginEditable name="EditRegion3" -->
    <form id="form1" name="form1" method="post" action="newplan12_Servlet">
      <p>1. 组织保障</p>
      <p>
        <label for="bz"></label>
        <textarea name="bz" id="bz" cols="65" rows="5"></textarea>
      </p>
      <p>2. 通信保障</p>
      <p>
        <textarea name="bz2" id="bz2" cols="65" rows="5"></textarea>
      </p>
      <p>3. 资金保障</p>
      <p>
        <textarea name="bz3" id="bz3" cols="65" rows="5"></textarea>
      </p>
      <p>4. 队伍保障</p>
      <p>
        <textarea name="bz4" id="bz4" cols="65" rows="5"></textarea>
      </p>
      <p>5. 交通运输保障</p>
      <p>
        <textarea name="bz5" id="bz5" cols="65" rows="5"></textarea>
      </p>
      <p>6. 物资保障</p>
      <p>
        <textarea name="bz6" id="bz6" cols="65" rows="5"></textarea>
      </p>
      <p>7. 宣传保障</p>
      <p>
        <textarea name="bz7" id="bz7" cols="65" rows="5"></textarea>
      </p>
      <p>8. 安全保障</p>
      <p>
        <textarea name="bz8" id="bz8" cols="65" rows="5"></textarea>
      </p>
      <p align="center">
