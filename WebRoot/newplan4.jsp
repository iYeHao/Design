...
<div class="container">
  ...
  <div class="content" align="center"><!-- InstanceBeginEditable name="EditRegion3" -->
    <form id="form1" name="form1" method="post" action="newplan4_Servlet">
      <p>1.领导机构及职责：
</p>
      <p>
        <label for="ldzz"></label>
        <textarea name="ldzz" id="ldzz" cols="65" rows="5"></textarea>
      </p>
      <p>2.指挥机构及职责：</p>
      <p>
        <label for="zhzz"></label>
        <textarea name="zhzz" id="zhzz" cols="65" rows="5"></textarea>
      </p>
      <p>3.指挥机构成员单位及职责：</p>
      <p>
        <label for="cyzz"></label>
        <textarea name="cyzz" id="cyzz" cols="65" rows="5"></textarea>
      </p>
      <p>4.现场指挥机构及职责：</p>
      <p>
        <label for="xczz"></label>
        <textarea name="xczz" id="xczz" cols="65" rows="5"></textarea>
      </p>
      <p>5.综合协调机构及职责：</p>
      <p>
        <label for="xtzz"></label>
        <textarea name="xtzz" id="xtzz" cols="65" rows="5"></textarea>
      </p>
      <p align="center">
