...
<div class="container">
  ...
  <div class="content" align="center"><!-- InstanceBeginEditable name="EditRegion3" -->
    <form id="form1" name="form1" method="post" action="newplan2_Servlet">
      <p>1.特别重大灾害事件：
      </p>
      <p>
        <textarea name="td" id="td" cols="65" rows="5"></textarea>
        <label for="td"></label>
      </p>
      <p>2.重大灾害事件：</p>
      <p>
        <label for="zd"></label>
        <textarea name="zd" id="zd" cols="65" rows="5"></textarea>
      </p>
      <p>3.较大灾害事件：</p>
      <p>
        <label for="jd"></label>
        <textarea name="jd" id="jd" cols="65" rows="5"></textarea>
      </p>
      <p>4.一般灾害事件：</p>
      <p>
        <label for="yb"></label>
        <textarea name="yb" id="yb" cols="65" rows="5"></textarea>
      </p>
      <p align="center">
