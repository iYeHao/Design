...
<div class="container">
  ...
  <div class="content" align="center"><!-- InstanceBeginEditable name="EditRegion3" -->
    <form id="form1" name="form1" method="post" action="newplan_Servlet">
      <p>&nbsp;</p>
      <p>编制目的：
        <label for="md"></label>
        <textarea name="md" rows="5" id="md" cols="40"><c:out value="${flist[0].ptext }"></c:out></textarea>
      </p>
      <p>编制依据：
        <label for="yj"></label>
        <textarea name="yj" rows="5" id="yj" cols="40"><c:out value="${flist[1].ptext }"></c:out></textarea>
      </p>
      <p>适用范围：
        <label for="fw"></label>
        <label for="fw"></label>
        <textarea name="fw" rows="5" id="fw" cols="40"><c:out value="${flist[2].ptext }"></c:out></textarea>
      </p>
      <p>
